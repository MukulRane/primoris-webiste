    ...
    <section className="improved-satisfaction-section">
      ...
      <div className="content-container">
        ...
        <div className="images-content">
          <img src={require('../../../images/management-consulting-improved-satisfaction-2.jpg')} alt="Consulting" className="image-bottom" />
          <img src={require('../../../images/management-consulting-improved-satisfaction-1.jpg')} alt="Consulting" className="image-top" />
        </div>
      </div>
    </section>
  );
