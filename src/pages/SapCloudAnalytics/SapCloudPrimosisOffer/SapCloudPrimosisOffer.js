...
const businessFunctionData = [
  [
    'Implementation, maintenance and extension of the solution',
    'Consulting, workshops and training for end-users'
  ],
  [
    'Integration of multiple data sources with SAP Analytics Cloud',
    'Building advanced, customized reports by a team of experienced developers'
  ]
];

const SapCloudPrimosisOffer = () => {
  return (
...
export default SapCloudPrimosisOffer;
